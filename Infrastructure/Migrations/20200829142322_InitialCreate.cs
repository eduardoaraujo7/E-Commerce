        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    USR_ENDERECP = table.Column<string>(maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PDR_DESCRICAO = table.Column<string>(maxLength: 150, nullable: true),
                    PDR_OBSERVACAO = table.Column<string>(maxLength: 2000, nullable: true),
                    PRD_VALOR = table.Column<decimal>(nullable: false),
                    PDR_QTD_ESTOQUE = table.Column<int>(nullable: false),
                    UserId = table.Column<string>(nullable: true),
                    PRD_ESTADO = table.Column<bool>(nullable: false),
                    PDR_DATA_CADASTRO = table.Column<DateTime>(nullable: false),
                    PDR_DATA_ALTERACAO = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
